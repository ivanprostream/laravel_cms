...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                  <form method="GET" action="{{ url('/admin/slider') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 d-inline-block float-l" role="search">
                    ...
                    <a href="{{ url('/admin/slider/create') }}" class="btn btn-success pull-right btn-sm float-r" title="Добавить">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                <a href="{{ url('admin/slider/sliders', $item->id) }}" title="Слайды"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Слайды</button></a>
