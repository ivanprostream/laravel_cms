        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ url('/admin/structure') }}">Структура сайта</a></li>
              <li class="breadcrumb-item"><a href="{{ url('/admin/pages/'.$page->id) }}">{{ $page->name }}</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="{{ url('/admin/pages/gallery_create/' . $id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                  {{ method_field('PATCH') }}
                  {{ csrf_field() }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                        <label for="image" class="control-label">{{ 'Описание' }}</label>
