<!-- Tell the browser to be responsive to screen width -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('public/theme/plugins/daterangepicker/datepicker.min.css') }}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('public/theme/plugins/fullcalendar/fullcalendar.min.css') }}">
  ...
  <!-- Sort table -->
  <link rel="stylesheet" href="{{ url('public/theme/plugins/datatables-bs4/css/dataTables.bootstrap4.css') }}">
  <link rel="stylesheet" href="{{ url('public/theme/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('public/theme/favicon/apple-touch-icon.png') }}">
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('public/theme/favicon/favicon-32x32.png') }}">
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public/theme/favicon/favicon-16x16.png') }}">
  <link rel="manifest" href="{{ asset('public/theme/favicon/site.webmanifest') }}">